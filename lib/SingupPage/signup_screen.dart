...
class _SignUpState extends State<SignUp> with TickerProviderStateMixin{
  ...
  void _getFromCamera() async{
    XFile? picakedFile = await ImagePicker().pickImage(source: ImageSource.camera);
    _cropImage(picakedFile!.path);
    Navigator.pop(context);
  }

  void _getFromGallery() async{
    XFile? picakedFile = await ImagePicker().pickImage(source: ImageSource.gallery);
    Navigator.pop(context);
  }
                      ...
                      Center(
                        child: RichText(
                            ...
                            children: [
                              ...
                              const TextSpan(
                                text: '     ',// for Space between Login and Already have an account
                              ),
                              TextSpan(
